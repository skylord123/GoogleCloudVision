...
component {
	...
	// Module Entry Point
	this.entryPoint			= "GoogleCloudVision";
	// Model Namespace
	this.modelNamespace		= "GoogleCloudVision";
	// CF Mapping
	this.cfmapping			= "GoogleCloudVision";
	// Auto-map models
	...
	*/
	function onLoad(){
		...
		// Map GoogleCloudVision
		binder.map( "VisionClient@GoogleCloudVision" )
			.to( "#moduleMapping#.models.VisionClient" )
